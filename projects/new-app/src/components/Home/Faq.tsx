                                    ...
                                    <div className="accordion accordion-faq" id="accordionFlushExample">
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            <div id="flush-collapseTwo" className="accordion-collapse collapse"
                                                ...
                                                <div className="accordion-body bg-lightgrey p-6">Placeholder content for this accordion, which is
                                                    intended to demonstrate the <code>.accordion-flush</code> className. This is the second item's
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            <div id="flush-collapseThree" className="accordion-collapse collapse"
                                                data-bs-parent="#accordionFlushExample">
                                                <div className="accordion-body bg-lightgrey p-6">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                    elit. Curabitur interdum, arcu a accumsan vulputate, leo diam sodales mi, et bibendum mi nunc at
                                                    lorem. Etiam ut nisi hendrerit,</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
