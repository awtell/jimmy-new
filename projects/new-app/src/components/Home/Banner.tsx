                        ...
                        <div className="col-lg-6 order-2 order-lg-1">
                            <div className="banner-left text-center pb-lg-5 p-md-0">
                                <div className="banner-image">
                                    <img src={bannerImage} alt="banner-image" className="w-50" /><br />
                                </div>
                                <div className="countdown">
                                    <div id="countdown"
                                        ...
                                        <div className="time m-auto py-4">
                                            <span id="days" className="lh-1 h1 fw-bold">{countdown.days}</span><br />
                                            <small className="text-secondary">Days</small>
                                        </div>

                                        <div className="time m-auto py-4">
                                            <span id="hours" className="lh-1 h1 fw-bold">{countdown.hours}</span><br />
                                            <small className="text-secondary">Hours</small>
                                        </div>

                                        <div className="time m-auto py-4">
                                            <span id="minutes" className="lh-1 h1 fw-bold">{countdown.minutes}</span><br />
                                            <small className="text-secondary">Minutes</small>
                                        </div>

                                        <div className="time m-auto py-4">
                                            <span id="seconds" className="lh-1 h1 fw-bold">{countdown.seconds}</span><br />
