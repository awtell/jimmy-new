import bannerImage from '../../images/team/4.png';
            ...
            <div className="container">
                <div className="schedule-inner">
                    <div className="schedule-title text-center mb-6 w-lg-60 mx-auto">
                        ...
                        <p className="m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                    </div>
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-3 col-md-4">
                                    <div className="schedule-day text-center text-sm-start py-6 position-relative ps-2 z-1">
                                        ...
                                        <p>William Mathew Theater<br />2390 NW 2nd Ave, Miami, FL 33127</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="schedule-list text-center text-sm-start">
                                        <div className="schedule-list-box bg-lightgrey border border-white border-2 rounded px-6 py-4 mb-5">
                                            <div className="schedule-box-title">
                                                <h5 className="mb-2">
                                                    <a href="event-detail.html" className="black">REGISTRATION & BREAKFAST</a>
                                                </h5>
                                            </div>
                                            <div className="schedule-box-info">
                                                <p className="mb-2">
                                                    <small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec ullamcorper mattis, pulvinar dapibus leo.</small>
                                                </p>
                                                <ul className="mb-2 p-0">
                                                    <li className="d-inline">
                                                        <i className="fa fa-clock-o pink me-2" aria-hidden="true"></i>
                                                        <small>08:30 - 09:30 AM</small>
                                                    </li>
                                                    <li className="d-inline">
                                                        <i className="fa fa-thumb-tack pink mx-2" aria-hidden="true"></i>
                                            ...
                                            <div className="schedule-box-bio d-md-flex">
                                                <div className="schedule-bio-image">
                                                    <img src={bannerImage} alt="team-image" className="me-2 rounded-circle" />
                                                </div>
                                                <div className="schedule-bio-info">
                                                    <p className="mt-1 mb-0">
                                                        <a href="speaker_detail.html" className="pink">JESUS HOLLAND</a>
                                                    </p>
                                        ...
                                        <div className="schedule-list-box bg-white border-lightgrey border border-2 rounded px-6 py-4">
                                            <div className="schedule-box-title">
                                                <h5 className="mb-2">
                                                    <a href="event-detail.html" className="black">SPEED: MARKETING MASTER!</a>
                                                </h5>
                                            </div>
                                            <div className="schedule-box-info">
                                                <p className="mb-2">
                                            ...
                                            <div className="schedule-box-bio d-md-flex">
                                                ...
                                                <div className="schedule-bio-info">
                                                    <p className="mt-1 mb-0">
                                                        <a href="speaker_detail.html" className="pink">NELSON KETY</a>
                                                    </p>
                                                    <small>Host & Speaker</small>
                                                </div>
                                            </div>
                                ...
                                <div className="col-lg-9 col-md-8">
                                    <div className="schedule-list text-center text-sm-start">
                                        ...
                                        <div className="partner-button mt-6">
                                            <a className="btn" href="event_list.html">VIEW MORE DETAILS</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
